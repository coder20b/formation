...
class Model
{
    ...
    static function compterLigne ($table, $colonne="", $valeurReherche="")
    {
        ...
        $resultat = Model::envoyerRequeteSql($requeteSQL, $tabAsso);
    ...
    static function lireLigne ($table, $colonne, $valeurFiltre, $tri="id DESC")
    {
        $ligneTri = "";
        ...
        $resultat = Model::envoyerRequeteSql($requeteSQL, []);
    ...
    // ETAPE 1: DEFINITION
    static function envoyerRequeteSql ($requeteSQL, $tabAsso)
    {
    ...
    static function insererLigne ($table, $tabAsso)
    {
        $listeColonne = "";
        $listeToken   = "";
    ...
    static function supprimerLigne($table, $id)
    {
        ...
        $resultat = Model::envoyerRequeteSql($requeteSQL, [ "id" => $id ]);
        return $resultat;
    }


    static function modifierLigne ($table, $id, $tabAsso)
    {
