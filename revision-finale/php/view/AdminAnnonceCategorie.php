...
trait AdminAnnonceCategorie
{
    static function sectionAdminAnnonceCategorie ()
    {
?>


<section>
    <h3>CRUD SUR LA TABLE SQL annonce_categorie</h3>
</section>
...
<section>
    ...
    <form method="POST" action="#form-create" id="form-create" enctype="multipart/form-data">
        <label>
            ...
            <input type="number" name="annonce_id" required placeholder="annonce_id" maxlength="160">
        </label>
        <label>
            <span>categorie_id</span>
            <input type="number" name="categorie_id" required placeholder="categorie_id" maxlength="160">
        </label>
        <button type="submit">CREER VOTRE LIEN ANNONCE-CATEGORIE</button>
        <!-- PARTIE TECHNIQUE -->
        <input type="hidden" name="formIdentifiant" value="annonce_categorie">
        <div>
        </div>
    </form>
</section>
...
<section class="cache">
    ...
    <form method="POST" action="#form-delete" id="form-delete">
        <label>
            ...
            <input type="text" name="table" required placeholder="table" maxlength="160" value="annonce_categorie">
        </label>
        <label>
            <span>id</span>
...
<section class="cache">
    <h3>UPDATE SUR LA TABLE SQL categorie (en dernier)</h3>
    <!-- POUR UPLOAD IL FAUDRA AJOUTER UN ATTRIBUT SUPPLEMENTAIRE... -->
    <!-- https://www.w3schools.com/php/php_file_upload.asp -->
    <form method="POST" action="#form-create" id="form-create" enctype="multipart/form-data">
        <label>
        ...
        <label>
            <span>categorie_id</span>
            <input type="number" name="categorie_id" required placeholder="annonce_id" maxlength="160">
        </label>
        <label>
            <span>id</span>
            <input type="number" name="id" required placeholder="id" maxlength="160">
        </label>
        <button type="submit">MODIFIER VOTRE LIEN ANNONCE-CATEGORIE</button>
        <!-- PARTIE TECHNIQUE -->
        <input type="hidden" name="formIdentifiant" value="annonce_categorie-update">
    </form>
</section>
...
<section>
    ...
    <div>
        <?php TraitementAnnonceCategorie::create() ?>
        <?php TraitementAnnonceCategorie::update() ?>
        <?php TraitementAnnonceCategorie::delete() ?>
    </div>
</section>
...
<section>
    ...
    <h3>Il y a <?php echo Model::compterLigne("annonce_categorie") ?> lignes dans la table</h3>
    <table>
        <tbody>
<?php
$tabLigne = Model::lireTable("annonce_categorie", "id DESC", 0, -1);  // TABLEAU ORDONNE DE TABLEAUX ASSOCIATIFS
...
foreach($tabLigne as $ligneAsso)
{
    ...
    <template class="template-update-$id">
        ...
        <form method="POST" action="#form-create" id="form-create" enctype="multipart/form-data">
            <label>
                <span>annonce_id</span>
                <input type="number" name="annonce_id" required placeholder="annonce_id" maxlength="160" value="$annonce_id">
            </label>
            <label>
                <span>categorie_id</span>
                <input type="number" name="categorie_id" required placeholder="categorie_id" maxlength="160" value="$categorie_id">
            </label>
            <label class="cache">
                <span>id</span>
