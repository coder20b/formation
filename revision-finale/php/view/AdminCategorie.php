...
trait AdminCategorie
{
    static function sectionAdminCategorie ()
    {
?>


<section>
    <h3>CRUD SUR LA TABLE SQL categorie</h3>
</section>
...
<section>
    ...
    <form method="POST" action="#form-create" id="form-create" enctype="multipart/form-data">
        <label>
            <span>label</span>
            <input type="text" name="label" required placeholder="label" maxlength="160">
        </label>
        <button type="submit">CREER VOTRE CATEGORIE</button>
        <!-- PARTIE TECHNIQUE -->
        <input type="hidden" name="formIdentifiant" value="categorie">
        <div>
        </div>
    </form>
</section>
...
<section class="cache">
    ...
    <form method="POST" action="#form-delete" id="form-delete">
        <label>
            ...
            <input type="text" name="table" required placeholder="table" maxlength="160" value="categorie">
        </label>
        <label>
            <span>id</span>
...
<section class="cache">
    ...
    <form method="POST" action="#form-create" id="form-create" enctype="multipart/form-data">
        ...
        <button type="submit">MODIFIER VOTRE CATEGORIE</button>
        <!-- PARTIE TECHNIQUE -->
        <input type="hidden" name="formIdentifiant" value="categorie-update">
    </form>
</section>
...
<section>
    ...
    <div>
        <?php TraitementCategorie::create() ?>
        <?php TraitementCategorie::update() ?>
        <?php TraitementCategorie::delete() ?>
    </div>
</section>
...
<section>
    ...
    <h3>Il y a <?php echo Model::compterLigne("categorie") ?> lignes dans la table</h3>
    <table>
        <tbody>
<?php
$tabLigne = Model::lireTable("categorie", "id DESC", 0, -1);  // TABLEAU ORDONNE DE TABLEAUX ASSOCIATIFS
...
foreach($tabLigne as $ligneAsso)
{
    ...
    <template class="template-update-$id">
        ...
        <form method="POST" action="#form-create" id="form-create" enctype="multipart/form-data">
            <label>
                <span>label</span>
                <input type="text" name="label" required placeholder="label" maxlength="160" value="$label">
            </label>
            <label class="cache">
                <span>id</span>
